...
--
-- Table structure for table `usuarios` (Versión Mejorada para PESV)
--
...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `fk_usuarios_empresa` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`empresa_id`) ON DELETE CASCADE
