...
CREATE TABLE `alerta` (
  ...
  CONSTRAINT `alerta_ibfk_1` FOREIGN KEY (`formulario_id`) REFERENCES `formulario` (`formulario_id`)
...
INSERT INTO `alerta` VALUES (1,1,'Advertencia','Este es un mensaje de alerta','2025-05-24 19:02:54');
